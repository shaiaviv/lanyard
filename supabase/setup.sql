...
from (values
  ...
  ('00000000-0000-0000-0000-0000000000e4','Money20/20 Europe 2026','00000000-0000-0000-0000-0000000000a2','2026-06-03 14:00+00','warm', array['integration','security'], 'Still engaged, steady. Asked integration and security questions.', true, '{"name":"Marcus Weber","company":"Lunar","title":"Head of Payments","email":"marcus.weber@lunar.app","linkedin":"https://www.linkedin.com/in/marcus-weber-pay"}','{"source":"seed"}')
